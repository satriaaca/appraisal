<?php
  ...
  if(isset($_SESSION['role'])) header('Location:dashboard.php?page=main');
  $failed = "";
  if (isset($_POST['submit'])) {
    ...
    if ($row > 0) {
      ...
      header("Location:dashboard.php?page=main");
        ...
        $failed = "Login Error : Please check your username or password !!";
    }
...
<div class="login-box">
  <div class="login-logo">
    <a href="../index.html"><b>E-APPRAISAL</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">

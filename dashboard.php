...
<div class="wrapper">
  ...
  <div class="content-wrapper bg-dark1">
    ...
    <?php
        ...
        switch($pages){
            case "add-appraisal" :
                include('pages/appraisal/add.new.php');
                break;
            case "view-appraisal" :
                include('pages/appraisal/view.php');
                break;
            case "add-question" :
                include('pages/question/add.new.php');
                break;
            case "view-question" :
                include('pages/question/view.php');
                break;
            case "edit-question" :
                include('pages/question/edit.php');
                break;
            case "delete-question" :
                include('pages/question/delete.php');
                break;
            case "main" :
                include('pages/main/view.php');
                break;
            case "insert-appraisal";
                include('pages/appraisal/insert-appraisal.php');
                break;
            case "appraisal-result";
                include('pages/appraisal/result-appraisal.php');
                break;
        } 
    ?>
